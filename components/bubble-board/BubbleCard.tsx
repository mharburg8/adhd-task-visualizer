...
export function BubbleCard({ task, onClick }: BubbleCardProps) {
  ...
  const ariaLabel = `Task: ${task.name}${
  ...
  return (
    <button
      ...
      className="absolute bubble-float rounded-full flex items-center justify-center text-center cursor-pointer hover:scale-105 transition-transform focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
      style={{
        width: diameter,
        height: diameter,
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          fontSize: diameter > 140 ? '14px' : '12px',
