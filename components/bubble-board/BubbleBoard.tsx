    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <p className="text-lg font-medium" style={{ color: 'var(--color-text)' }}>Nothing on your plate right now</p>
          <p className="text-sm mt-1" style={{ color: 'var(--color-text-muted)' }}>Add a task to get started</p>
        </div>
      </div>
    )
  }
